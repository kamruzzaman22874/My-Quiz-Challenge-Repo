...
const ShowQuiz = ({quiz ,loadQuiz}) => {
  // console.log(loadQuiz);
    ...
    return (
  <div className="card bg-base-100 shadow-xl p-3  mt-2 h-[90%] ">
    <figure className='bg-slate-600 w-50 mx-auto rounded-lg '><img className='w-[50%] ' src= {logo} alt="logo" /></figure>
   <div className='flex'>
   <div className="card-body lg:ml-8 mx-[-22px]">
    <h2 className="card-title font-bold text-xl ">
       {name}
    </h2>
    <p className='lg:text-xl font-bold lg:py-2 '>Total Quiz :{total}</p>
   </div>
    <div className="card-actions justify-end lg:py-16 py-8 lg:px-14">

...
const ErrorElement = () => {
    return (
        <div className='text-3xl bg-blue-900 lg:m-36 rounded-xl text-black-600'>
            <h2 className='py-6  lg:w-96 mx-auto  lg:px-[40px] px-[40px] mt-4 mb-4 lg:text-2xl text-xl text-white lg:animate-ping'>🚫This page is not found🚫</h2>
